...
build-017:
	time docker build --no-cache --build-arg PARTICL_VERSION=0.17.0.3 --build-arg CONTAINER_TIMEZONE=Europe/Helsinki -t ludx/particl:0.17 -t ludx/particl:0.17.0.3 -t docker.io/ludx/particl:0.17.0.3 -t docker.io/ludx/particl:latest .
...
push-017:
	docker push docker.io/ludx/particl:0.17.0.3
