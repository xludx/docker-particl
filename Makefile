...
build-016:
	time docker build --no-cache --build-arg PARTICL_VERSION=0.16.0.7 --build-arg CONTAINER_TIMEZONE=Europe/Helsinki -t ludx/particl:0.16.0.7 -t docker.io/ludx/particl:0.16.0.7 -t docker.io/ludx/particl:latest .
