...
build-017:
	time docker build --no-cache --build-arg PARTICL_VERSION=0.17.1.0 --build-arg CONTAINER_TIMEZONE=Europe/Helsinki -t ludx/particl:0.17 -t ludx/particl:0.17.1.0 -t docker.io/ludx/particl:0.17.1.0 -t docker.io/ludx/particl:latest .

build-018:
	time docker build --no-cache --build-arg BUILD=false --build-arg PARTICL_VERSION=0.18.0.5rc1 --build-arg CONTAINER_TIMEZONE=Europe/Helsinki -t ludx/particl:0.18 -t ludx/particl:0.18.0.5rc1 -t docker.io/ludx/particl:0.18.0.5rc1 -t docker.io/ludx/particl:latest .
...
push-017:
	docker push docker.io/ludx/particl:0.17.1.0
	docker push docker.io/ludx/particl:0.17

push-018:
	docker push docker.io/ludx/particl:0.18.0.5rc1
