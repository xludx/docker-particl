...
build-018:
	time docker build --no-cache --build-arg BUILD=true --build-arg PARTICL_VERSION=0.18.0.4alpha --build-arg CONTAINER_TIMEZONE=Europe/Helsinki -t ludx/particl:0.18 -t ludx/particl:0.18.0.4alpha -t docker.io/ludx/particl:0.18.0.4alpha -t docker.io/ludx/particl:latest .
