...
build-018:
	time docker build --no-cache --build-arg BUILD=false --build-arg PARTICL_VERSION=0.18.0.11 --build-arg CONTAINER_TIMEZONE=Europe/Helsinki -t ludx/particl:0.18 -t ludx/particl:0.18.0.11 -t docker.io/ludx/particl:0.18.0.11 -t docker.io/ludx/particl:latest .
...
push-018:
	docker push docker.io/ludx/particl:0.18.0.11
